...
class Runner(object):
    ...
    def __init__(self, \
     ...
     #  self.MEDIA_TYPES   = ["ssd", "hdd", "nvme", "mem"]
        self.MEDIA_TYPES   = ["ssd"]
     #  self.FS_TYPES      = ["tmpfs", "ext2", "ext3", "ext4", "ext4_no_jnl", "xfs", "btrfs", "f2fs", "jfs", "reiserfs"]
     #  self.FS_TYPES      = ["tmpfs", "ext4", "ext4_no_jnl", "xfs", "btrfs", "f2fs",
        self.FS_TYPES      = ["nfs"]
        self.BENCH_TYPES   = [
            # write/write
             "DWAL",
    ...
    def fxmark(self, media, fs, bench, ncore, nfg, nbg, dio):
        ...
        if bench.startswith("filebench_") or bench.startswith("dbench_"):
        ...
        print("start : %s : %s" % (datetime.datetime.now(), cmd))
...
if __name__ == "__main__":
    ...
    run_config = [
        # (Runner.CORE_FINE_GRAIN,     PerfMon.LEVEL_LOW, ("mem", "*", "DWOL", "4", "directio")),
        (Runner.CORE_FINE_GRAIN,   PerfMon.LEVEL_LOW, ("ssd", "*", "*", "*", "*")),
        # (Runner.CORE_COARSE_GRAIN, PerfMon.LEVEL_PERF_RECORD, ("*", "*", "*", "*", "bufferedio")),
        # (Runner.CORE_COARSE_GRAIN, PerfMon.LEVEL_PERF_RECORD, ("*", "*", "*", str(cpupol.PHYSICAL_CHIPS * cpupol.CORE_PER_CHIP), "*"))
    ]
